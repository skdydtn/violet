...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Violet " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"violet.blockchain-creator.com", "blockchain-creator.com"},
    {"[182.23.209.86", "[182.23.209.86"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Violet is probably already running."), addrBind.ToString().c_str());
        else
